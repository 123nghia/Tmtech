...
namespace TmTech_v1.View
{
    public partial class frmProductPriceDetail : MetroForm
    {
        ...
        private void Create()
        {
            ...
            productPrice.Name = txtName.Text;
            ...
            productPrice.ProductId = int.Parse(cbbProdCode.SelectedValue.ToString());
            productPrice.CreateBy = UserManagement.UserSession.Id;
        ...
        {
            if (price.Id <= 0) return;
            price.Name = txtName.Text;
            ...
            price.ModifyBy = UserManagement.UserSession.Id;
        ...
        private void cbbProdCode_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            {
                txtProductName.Text = ((Product)cbbProdCode.SelectedItem).Name;
            }
        }
    }
}
